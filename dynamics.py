...
Write a function for an elastic collision, that takes in the masses and the initial velocities of two bodies , and return the respective final velocities of the two bodies.
